...
/datum/admins/proc/change_weather()
	...
	var/datum/planet/planet = input(usr, "Which planet do you want to modify the weather on?", "Change Weather") in list(planet_eros)
...
/datum/admins/proc/change_time()
	...
	var/datum/planet/planet = input(usr, "Which planet do you want to modify time on?", "Change Time") in list(planet_eros)
