/datum/job
	...
	var/list/species_restricted = list()  // Species in this list will not be able to join as the job marked.
	...
	var/announced = 1					  //If their arrival is announced on radio
