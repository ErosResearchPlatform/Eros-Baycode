var/datum/planet/eros/planet_eros = null
...
/datum/planet/eros
	name = "eros"
	desc = "eros is a terrestrial planet in the Vir system. It is somewhat earth-like, in that it has oceans, a \
	...
	current_time = new /datum/time/eros() // 32 hour clocks are nice.
	expected_z_levels = list(2, 5) // To be changed when real map is finished.

/datum/planet/eros/New()
	..()
	weather_holder = new /datum/weather_holder/eros(src) // Cold weather is also nice.

// This code is horrible.
/datum/planet/eros/update_sun()
	..()
