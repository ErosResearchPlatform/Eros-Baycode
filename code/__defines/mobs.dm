...
#define BP_TAUR   "taur"
#define BP_TAUR_OVERRIDDEN list(BP_L_LEG, BP_R_LEG, BP_L_FOOT, BP_R_FOOT) //body parts that should point to taur instead if present
#define BP_ALL_LIMBS list(BP_CHEST, BP_GROIN, BP_HEAD, BP_L_ARM, BP_R_ARM, BP_L_HAND, BP_R_HAND, BP_L_LEG, BP_R_LEG, BP_L_FOOT, BP_R_FOOT, BP_TAUR)
#define BP_BY_DEPTH list(BP_HEAD, BP_L_HAND, BP_R_HAND, BP_L_ARM, BP_R_ARM, BP_L_FOOT, BP_R_FOOT, BP_L_LEG, BP_R_LEG, BP_TAUR, BP_GROIN, BP_CHEST)
