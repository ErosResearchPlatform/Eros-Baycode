...
// We're gonna pretend there are 32 hours in a eros day instead of 32.64 for the purposes of not losing sanity.  We lose 38m 24s but the alternative is a path to madness.
/datum/time/eros
