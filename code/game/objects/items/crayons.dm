...
/obj/item/weapon/pen/soapstone/afterattack(atom/target, mob/user as mob, proximity)
	...
	if(istype(target,/turf/simulated/floor))
		...
		var/basephrase = input("Choose your base phrase.", "Crayon scribbles") in list("**** ahead.","Be wary of ****.","Try ****.","Need ****.","Imminent ****...","Weakness: ****","****.","****?","Good luck.","I did it!","Here!","I can't take this...","Praise the Sun!")
		var/fillphrase
		var/fillcategory
		if(basephrase == "**** ahead." || basephrase == "**** ahead." || basephrase == "Be wary of ****." || basephrase == "Try ****." || basephrase == "Need ****." || basephrase == "Imminent ****..." || basephrase == "Weakness: ****" || basephrase == "****." || basephrase == "****?")
			fillcategory = input("Choose a phrase category to fill in the blank.", "Crayon scribbles") in list("Characters","Objects","Techniques","Actions","Geography","Orientation","Body Parts","Attributes","Concepts")
			switch(fillcategory)
				if("Characters")
					fillphrase = input("Choose a phrase to fill in the blank.", "Crayon scribbles") in catcharacters
					to_chat(user, "You begin writing...")
				if("Objects")
					fillphrase = input("Choose a phrase to fill in the blank.", "Crayon scribbles") in catobjects
					to_chat(user, "You begin writing...")
				if("Techniques")
					fillphrase = input("Choose a phrase to fill in the blank.", "Crayon scribbles") in cattechniques
					to_chat(user, "You begin writing...")
				if("Actions")
					fillphrase = input("Choose a phrase to fill in the blank.", "Crayon scribbles") in catactions
					to_chat(user, "You begin writing...")
				if("Geography")
					fillphrase = input("Choose a phrase to fill in the blank.", "Crayon scribbles") in catgeography
					to_chat(user, "You begin writing...")
				if("Orientation")
					fillphrase = input("Choose a phrase to fill in the blank.", "Crayon scribbles") in catorientation
					to_chat(user, "You begin writing...")
				if("Body Parts")
					fillphrase = input("Choose a phrase to fill in the blank.", "Crayon scribbles") in catbodyparts
					to_chat(user, "You begin writing...")
				if("Attributes")
					fillphrase = input("Choose a phrase to fill in the blank.", "Crayon scribbles") in catattributes
					to_chat(user, "You begin writing...")
				else
					fillphrase = input("Choose a phrase to fill in the blank.", "Crayon scribbles") in catconcepts
					to_chat(user, "You begin writing...")
		else
			to_chat(user, "You begin writing...")
		var/message = "blank"
